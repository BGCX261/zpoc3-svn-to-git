...
namespace FlowLib.Protocols.HubZpoc
{
    ...
    public class MyINFO : HubMessage
    {
        ...
        public MyINFO(Hub hub, byte flg)
            : base(hub, null)
        {
			//$MyINFO $ALL DisplayName Description goes here  † ZPoc V:3.00a, S:2, M:A † $ $56Kbps$email@host.com$0$|
            this.info = hub.Me;
            this.statusFlag = flg;
    ...
    {
        public static string ConvertToZpoc(string str)
        {
            str = str.Replace("&", "&amp;");
            str = str.Replace("&#124;", "&#36;");
            str = str.Replace("$", "&#124;");
        ...
        public static string ConvertFromZpoc(string str)
        {
            str = str.Replace("&#124;", "$");
            str = str.Replace("&#36;", "&#124;");
            str = str.Replace("&amp;", "&");
    ...
    public class Version : HubMessage
    {
        ...
        {
            //version = "1.0091";
			string ip = hub.Me.Get("UserInfo.IP");
			int ihour = System.DateTime.Now.Hour;
			int imin = System.DateTime.Now.Minute;
			int isec = System.DateTime.Now.Second;
			string hour = ihour.ToString();
			string min = imin.ToString();
			string sec = isec.ToString();
			if(ihour < 10) { hour = "0" + hour; }
			if(imin < 10) { min = "0" + min; }
			if(isec < 10) { sec = "0" + sec; }
			version = ip + hour + ":" + min + ":" + sec;
            Raw = "$Version "+version+"|";
            IsValid = true;
        }
    }
