...
namespace FlowLib.Connections
{
    ...
    public class Hub : TcpConnection
    {
		...
		protected HubName hubname = null;
        #endregion
        #region Properties
        /// <summary>
		...
		/// <summary>
		/// Gets the name of the hub as reported to the client
		/// </summary>
		public string Name
		{
			get { return this.hubname.Name; }
		}
		/// <summary>
		/// Gets the topic of the hub as reported to the client
		/// </summary>
		public string Topic
		{
			get { return this.hubname.Topic; }
		}
        /// <summary>
