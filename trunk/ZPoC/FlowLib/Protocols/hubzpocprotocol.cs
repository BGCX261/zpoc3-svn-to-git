...
using FlowLib.Protocols.HubZpoc;
...
namespace FlowLib.Protocols
{
    ...
    /// Hub Zpoc Protocol
    /// </summary>
    public class HubZpocProtocol : IProtocolHub
    {
        #region Events
        /// <summary>
        ...
        public HubZpocProtocol(Hub hub)
        {
            this.hub = hub;
        ...
        public void ActOnInMessage(IConMessage comMsg)
        {
            ...
            else if (message is HubZpoc.HubName)
            {
                HubZpoc.HubName hubname = (HubZpoc.HubName)message;
